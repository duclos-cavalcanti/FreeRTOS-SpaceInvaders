...
A loosely based version of the classic arcade video game - Space Invaders - developed by Tomohiro Nishikado and released in 1978. This project was written in C and based upon a FreeRTOS emulator. This was done so as a class assignment for the Technical University of Munich under the Embedded System Programming Lab. Corresponding documentation to this tool and simple guidelines on how to use it will be seen below, as they were taken from [GitHub Pages](https://github.com/alxhoff/FreeRTOS-Emulator). Many sprites/bitmap images were taken and inspired from [GitHub Pages](https://github.com/flightcrank/space-invaders).
...
<a href="https://www.buymeacoffee.com/xmyWYwD" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/lato-green.png" alt="Buy My Professor A Coffee" style="height: 11px !important;" ></a>
